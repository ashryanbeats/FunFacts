...
- (UIColor *)randomColor {
    ...
    do {
        random = arc4random_uniform((int)self.colors.count);
    } while ([self.colors objectAtIndex:random] == self.previousColor);
    
    UIColor *selectedColor = [self.colors objectAtIndex:random];
    
    self.previousColor = selectedColor;
